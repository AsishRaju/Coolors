export default [
	...
	},
	{
		...
		colors: [
			...
			{ name: "YouTube-Black", color: "#282828" },
			{ name: "Android-Green", color: "#78C257" },
			{ name: "Amazon-Orange", color: "#FF9900" },
			{ name: "Amazon-Black", color: "#000000" },
			{ name: "Apple-Grey", color: "#555555" },
			{ name: "Facebook-Blue", color: "#4267B2" },
			{ name: "Microsoft-Orange-Red", color: "#F25022" },
			{ name: "Microsoft-Green", color: "#7FBA00" },
			{ name: "Microsoft-Blue", color: "#00A4EF" },
			{ name: "Microsoft-Yellow", color: "#FFB900" },
			{ name: "Microsoft-Gray", color: "#737373" },
			{ name: "WhatsApp-Teal-Green", color: "#128C7E" },
			{ name: "WhatsApp-Dark-Green", color: "#075E54" },
			{ name: "WhatsApp-Green", color: "#25D366" },
			{ name: "WhatsApp-Blue", color: "#34B7F1" },
		],
	},
	{
		paletteName: "Light Mix",
		id: "light-mix",
		emoji: "🍃",
		colors: [
	...
	},
	{
		...
		emoji: "🌌",
		colors: [
			{ name: "FlatFlesh", color: "#1b262c" },
			{ name: "MelonMelody", color: "#0f4c75" },
			{ name: "Livid", color: "#3282b8" },
			{ name: "Spray", color: "#46b5d1" },
			{ name: "ParadiseGreen", color: "#bbe1fa" },
			{ name: "SquashBlossom", color: "#022c43" },
			{ name: "MandarinRed", color: "#053f5e" },
			{ name: "AzraqBlue", color: "#206a5d" },
			{ name: "Dupain", color: "#81b214" },
			{ name: "Baack", color: "#bfdcae" },
			{ name: "IcelandPoppy", color: "#ffc93c" },
			{ name: "TomatoRed", color: "#26282b" },
			{ name: "YueGuangBlue", color: "#055e68" },
			{ name: "GoodSamaritan", color: "#eeeeee" },
			{ name: "Waterfall", color: "#393e46" },
			{ name: "CarrotOrange", color: "#76ead7" },
			{ name: "JalapenoRed", color: "#c4fb6d" },
			{ name: "DarkSapphire", color: "#0a91ab" },
			{ name: "ForestBlues", color: "#2d4059" },
			{ name: "ReefEncounter", color: "#cd0a0a" },
		],
	},
];
